...
const MolWidget2DView = Backbone.View.extend({
  ...
  setCss: function setCss() {
      if(document.querySelectorAll('#graph_css_style').length>0) { return }
      ...
      // TODO style appears to be undefined in the other repo too...
  ...
  renderViewer() {
      ...
      link.filter((d) => { return d.bond > 1; }).append('line')
